...
# قراءة التوكن من نظام اللوحة وتنظيفه
TOKEN = os.getenv("DISCORD_TOKEN")

if TOKEN:
    TOKEN = TOKEN.strip().strip('"').strip("'")
    print(f"DEBUG: Token loaded successfully, starting with -> {TOKEN[:5]}...")
else:
    print("❌ ERROR: الـ Dashboard لم تقم بتمرير متغير DISCORD_TOKEN نهائياً!")
    exit(1)
